...
//    private let baseURL = URL(string: "https://barbuddy-backend-148659891217.us-central1.run.app/api")!
//    private init() {}
//
...
//    func suggestions(for current: User) async throws -> [User] {
...
//            $0.sexualPreference == current.sexualPreference
//        }
//
//        // 3️⃣ Parse your coordinate
////        guard let meCoord = current.location else {
////            // If unable to parse, just sort by age
////            return sortByAge(prefMatched, referenceAge: 20)
//        }
//
//        // 4️⃣ Find which bar‑zone you’re in (unless override)
//        let myBar = ignoreBarFiltering
//            ? nil
//        : BarBoundaries.all.first { $0.contains(CLLocationCoordinate2D(latitude: meCoord.latitude, longitude: meCoord.longitude)) }
//
...
////        let (inSameBar, outsideBar) = prefMatched.reduce(into: ([User], [User])) {
////            guard let coord = $1.location,
////                  let bar   = myBar,
////                  bar.contains(CLLocationCoordinate2D(latitude: coord.latitude, longitude: coord.longitude))
////            else {
////                $0.1.append($1)
////                return
////            }
